...
export const StateComponent = () => {
    ...
    return (
        ...
        <h2 className="col-start-1 col-end-3 text-center text-2xl text-stone-700">{boardShow?.name}</h2>
        ...
        <section className="flex">
            ...
            <button
            onClick={()=> {fnOnOffBtnNewState()}}
            > + STATE </button>
        </section>
            {onOffBtnNewState?
                <NewStateModal
                fnOnOffBtnNewState={fnOnOffBtnNewState}
                >
            ...
            {onOffBtnNewTask?
            <NewTaskModal
            fnOnOffBtnNewTask={fnOnOffBtnNewTask}
            >
            </NewTaskModal>
            : null
            }
